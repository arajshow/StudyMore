...
const Home = () => {
	return (
		<div>
			...
			<div
				className="relative mx-auto max-w-maxContent flex flex-col w-11/12 lg:items-center sm:justify-start 
            text-white lg:justify-between text-left "
			>
				<Link to={"/signup"}>
					<div
						className="group mt-16 p-1 lg:mx-auto md:mx-auto mx-0 rounded-full bg-richblue-800 font-bold text-richblack-200
                    transition-all duration-200 hover:scale-95 w-fit shadow-[0_1px_0px_0px_#838894]"
					>
						<div
							className="flex flex-row items-center gap-10 rounded-full px-[18px] py-[6px]
